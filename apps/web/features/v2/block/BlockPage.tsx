...
export default function BlockPage({ areaId }: { areaId: string }) {
  ...
  if (!context)
    return (
      <main className="v2-block-page">
        ...
        <Link className="v2-button" href={routes.home}>
  ...
  return (
    <main className="v2-block-page">
      <div className="v2-contextbar">
        <div className="v2-block-title">
      ...
      <div
        className={`v2-block-grid ${leftOpen ? "v2-left-open" : ""} ${inspectorOpen ? "" : "v2-inspector-closed"}`}
      >
        <BlockLeftRail block={block} onClose={() => setLeftOpen(false)} />
        <section className="v2-map-column" aria-label="Shared block map">
          <div className="v2-map-stage">
            <div className="v2-map-toolbar">
              <div className="v2-map-mode">
                <button
            ...
            <div className="v2-map-compass">
              <Button
                aria-label="Orient north"
                onClick={() => block.navigate("north")}
              >
                <span>N</span>
                <span className="v2-north-arrow">▲</span>
              </Button>
            </div>
            <div className="v2-map-zoom">
              <Button
                icon="plus"
                aria-label="Zoom in"
            ...
            {block.finding && (
              <div className="v2-active-finding">
          ...
          <footer className="v2-map-status">
            <span>
              <i />
