    ...
    <>
      ...
      <div className={styles.documents}>
        {[...workspace.sources]
          .sort(
            (a, b) =>
              Number(["image", "pdf"].includes(b.kind)) -
              Number(["image", "pdf"].includes(a.kind)),
          )
          .map((item) => (
            <button
              key={item.id}
      ...
      <div className={styles.sourceMeta}>
        ...
        <details>
          <summary>About measurements</summary>
          <p>Saved on this device. Original documents remain unchanged.</p>
        </details>
      </div>
    </>
  );
  ...
  return (
    <div className={styles.workspace}>
      ...
      {sourceId &&
        ...
        !workspace.sources.some((item) => item.id === sourceId) && (
          <p className={styles.notice}>
            That document does not belong to this workspace. Showing an original
            from this property instead.
          </p>
        )}
