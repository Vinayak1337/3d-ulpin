...
See `docs/engineering-plan/tasks/T089_RESULT.md` for deployed revision, verified imported IDs and remaining limitations. Upload sources are in `data-source/`; import the complete ZIPs rather than individual evidence files. Presentation facts and judge questions now live in `docs/usp-agent-handoffs/24-product-method-and-ppt.md`.
