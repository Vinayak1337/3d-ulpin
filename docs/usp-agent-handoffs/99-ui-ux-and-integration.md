...
**Dataset policy update, 24 September 2026:** general map/load qualification uses real data from any suitable geography under H00 section 4. No Delhi/Uttam Nagar acquisition is required. D0/D1 smoke acceptance remains distinct from the larger real corpus, sparse-source and concurrent-ingestion interaction tests below; this documentation update does not claim those tests passed.
