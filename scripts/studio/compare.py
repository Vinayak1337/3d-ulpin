...
import hashlib, json, shutil, html, os
...
sources={
 ...
 'previous-map':ROOT/'docs/evidence/t058/final/map.png',
}
records={}
...
compare('continuation-before-after',[('previous-map','Previously committed Studio pass'),('current-map','Continued implementation / actual browser')])
notes=[
 ('Continuation completed in the same implementation','The continued pass shares the actual building envelope across district, register and workspace, adds fuller foliage and road/utility labels, corrects north-side parcel overlays, and improves the building-preview camera fit without altering the source fixture.'),
 ('Additional workflow verification','Property thumbnails and navigation are identity-qualified and atomic. Source checking validates original bytes and links. Floor-local drafts retain their notes, measurements, unit and revision; invalid geometry cannot enter review. Missing renderer assets have an explicit recoverable error state.'),
...
<h2>What changed in the continuation</h2><section><img src="continuation-before-after.png"><p class="caption">Previous committed Studio pass at left; continued implementation at right. Both are actual application renders.</p></section>
